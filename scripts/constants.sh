...
declare -ra VENDOR_SKIP_FILES=(
  ...
  "app/shutdownlistener/oat"
  "app/shutdownlistener/oat/arm64"
  "app/shutdownlistener/oat/arm64/shutdownlistener.odex"
  "app/shutdownlistener/oat/arm64/shutdownlistener.vdex"
  ...
  "bin/sha512sum"
  "bin/init.radio.sh"
  "etc/diag/MarlinSailfish_Radio-generic.cfg"
  "etc/mkshrc"
  ...
  "lib/libchromatix_imx179_zsl_snapshot_cpp.so"
  "lib/libmmcamera_isp_mesh_rolloff44.so"
  "lib/libchromatix_imx378_zsl_snapshot_cpp.so"
  "lib/libchromatix_imx179_zsl_snapshot_3a.so"
  "lib/libchromatix_imx179_zsl_snapshot_isp.so"
  "lib/libchromatix_imx378_zsl_snapshot_3a.so"
  "lib/librs_adreno_sha1.so"
  "lib/libchromatix_imx378_zsl_snapshot_isp.so"
  "lib/libflash_pmic.so"
  "lib/dsp/fastrpc_shell_0"
  "lib/dsp/map_avs_shared_libs.txt"
